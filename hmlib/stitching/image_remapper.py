...
from hmlib.utils.hockeymon_compat import ImageRemapper as NativeImageRemapper
from hmlib.utils.hockeymon_compat import RemapImageInfo
...
class ImageRemapper(torch.nn.Module):
    ...
    def init(self, batch_size: int):
        ...
        if self._remap_info is not None:
            ...
            self.xpos, self.ypos, x_map, y_map = read_mapping_arrays(self._dir_name, self._basename)
